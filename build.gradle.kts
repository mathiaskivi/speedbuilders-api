...
jreleaser {
        ...
        maven {
            mavenCentral {
                create("sonatype") {
                    ...
                    username = rootProject.findProperty("JRELEASER_MAVENCENTRAL_SONATYPE_USERNAME")?.toString() ?: System.getenv("JRELEASER_MAVENCENTRAL_SONATYPE_USERNAME")

                    // Password part of the generated token (https://central.sonatype.org/publish/generate-portal-token).
                    password = rootProject.findProperty("JRELEASER_MAVENCENTRAL_SONATYPE_PASSWORD")?.toString() ?: System.getenv("JRELEASER_MAVENCENTRAL_SONATYPE_PASSWORD")
                }
            }
        }
    }
    release {
        github {
            ...
            token = rootProject.findProperty("JRELEASER_GITHUB_TOKEN")?.toString() ?: System.getenv("JRELEASER_GITHUB_TOKEN")
        }
    }
    signing {
        active = Active.ALWAYS
        ...
        passphrase = rootProject.findProperty("JRELEASER_GPG_PASSPHRASE")?.toString() ?: System.getenv("JRELEASER_GPG_PASSPHRASE")

        // Path to the secret key file generated by GnuPG (gpg --output public.pgp --armor --export <KEY_PAIR_ID>).
        secretKey = rootProject.findProperty("JRELEASER_GPG_SECRET_KEY")?.toString() ?: System.getenv("JRELEASER_GPG_SECRET_KEY")

        // Path to the public key file generated by GnuPG (gpg --output secret.pgp --armor --export-secret-key <KEY_PAIR_ID>).
        publicKey = rootProject.findProperty("JRELEASER_GPG_PUBLIC_KEY")?.toString() ?: System.getenv("JRELEASER_GPG_PUBLIC_KEY")
    }
}
